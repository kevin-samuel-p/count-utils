...
wchar_t *translate_to_japanese(char *);
char *translate_from_japanese(wchar_t *);
void increment_numstring(char **);


wchar_t *translate_to_japanese(char *number)
{
    int n = strlen(number);
    if (n > 50)
    {
...
char *translate_from_japanese(wchar_t *japaneseNumber)
{
...
// Increment number by passing numstring by reference
